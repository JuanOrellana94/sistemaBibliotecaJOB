 ...
 <a class="navbar-brand text-white"> </a>
    ...
    <div class=" navbar-collapse" id="navbarSupportedContent">
      <ul class="nav justify-content-center" >
        ...
        <li class="nav-item">
          <a class="nav-link  text-white" href="catalogos.php?pageLocation=usuarios"> <img src="img/icons/User.png" width="20" height="20" > Usuarios</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  text-white" href="catalogos.php?pageLocation=equipo"> <img src="img/icons/equipment.png" width="20" height="20" >Equipo</a>
        </li>
      </ul>
    </div>
  </nav>
