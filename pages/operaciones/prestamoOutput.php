    ...
    <div class="card-body">
		...
		<form  id="formularioDetalles">
			<div class="row">
								 	...
								 	<h6 class="card-subtitle mb-2 text-muted" >Fecha de devolucion:</h6>
						                ...
						                <div id="infoDetalles"></div>
						              	...
						              	<div class="form-group">
						              		 ...
						              		 <div>
											 	<button type="button" name="cancelarPrestamo" id="cancelarPrestamo"  class="btn btn-danger"  onclick="reiniciarFormPrestamo()">Cancelar Prestamo</button> 
				...
				<div class="col-lg-7" >
					<div class="row" data-toggle="tooltip" data-placement="right"  title="Libros a Prestar">
						<div class="col-sm-12" >
							<div class="form-group" >
								<div id="infoLista">
