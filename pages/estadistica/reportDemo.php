...
$pdf->MultiCell(155,7,utf8_decode('Este informe hace constar que durante el año '.$selectYear.', se ha adquirido dentro de la biblioteca '.$countBook[0].' nuevos libros, con un total de '.$countEjem[0].' ejemplares unicos. El listado de cada libro y su respectiva cantidad de ejemplares se lista acontinuacion:
'),0,'J');
...
$pdf->MultiCell(169,7,utf8_decode('El total actual de libros registrados dentro de biblioteca es de '.$countEjem[0].', también con un total de libros extraviados de 30 para la culminación del año escolar.'),0,'J');
