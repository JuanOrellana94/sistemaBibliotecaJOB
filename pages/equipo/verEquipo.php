          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <div class="form-group">               
                ...
                <input maxlength="45"  type="text" class="form-control" name="formequicodifi" id="formequicodifi" aria-describedby="formequicodifi" placeholder="" onkeypress="return soloNumeros(event);" ><br>
                <label for="TituloLabel">NOMBRE EQUIPO</label>
                <input maxlength="45" style="text-transform:uppercase" onkeyup="javascript:this.value=this.value.toUpperCase();sendInsert(this,this.value);" type="text" class="form-control" name="formequiponom" id="formequiponom" aria-describedby="formequiponom" placeholder="" onkeypress=""><br>
                <label for="TituloLabel">DESCRIPCION DEL EQUIPO</label>
                <input  maxlength="100" style="text-transform:uppercase" onkeyup="javascript:this.value=this.value.toUpperCase();sendInsert(this,this.value);" type="text" class="form-control" maxlength="95" name="formequipodes" id="formequipodes" aria-describedby="formequipodes" placeholder="" >
              </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              ...
              <div class="form-group">
                ...
                <label for="TituloLabel">CODIGO</label>                 
                <input maxlength="45" type="text" class="form-control" name="editequicodifi" id="editequicodifi" aria-describedby="editequicodifi" placeholder="" onkeypress="return soloNumeros(event);"><br>
                <label for="TituloLabel">NOMBRE EQUIPO</label>
                <input maxlength="45" style="text-transform:uppercase" onkeyup="javascript:this.value=this.value.toUpperCase();sendEditar(this,this.value);" type="text" class="form-control" name="editequiponom" id="editequiponom" aria-describedby="editequiponom" placeholder="" onkeypress=""><br>
                <label for="TituloLabel">DESCRIPCION DEL EQUIPO</label>
                <input maxlength="100" style="text-transform:uppercase" onkeyup="javascript:this.value=this.value.toUpperCase();sendEditar(this,this.value);" type="text" class="form-control" maxlength="95" name="editequipodes" id="editequipodes" aria-describedby="editequipodes" placeholder="" >
              </div>
