...
$checkValidation="SELECT * FROM $tablaEjemplares WHERE $varejemcodreg='$reanuEjemplarcod' and $varejemestu='1';";
...
$dataRow = mysqli_fetch_array($resultado);	
	 ...
	 if($dataRow>0) {
		...
		$insRegistro=mysqli_query($conexion,"
			...
			SET $varejemestu='0' WHERE 	$varejemcodreg='$reanuEjemplarcod'	    
		    ;")
